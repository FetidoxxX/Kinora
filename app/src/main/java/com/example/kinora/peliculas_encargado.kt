...
class peliculas_encargado : nav_bar() {


    private lateinit var rvPeliculas: RecyclerView
    private val url: String = "http://192.168.1.4/Kinora/kinora_php/obtener_enc_peliculas.php" //Cristhian
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_peliculas_encargado)
        configurarNavBar()
    ...
    private fun cargarPeliculas() {
        ...
        val urlId = "$url?id_u=$idEncargado"
